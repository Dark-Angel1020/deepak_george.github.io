...
, function(t, e, n) {
    ...
    window.tram = function(t) {
        ...
        var P = e.frame = function() {
          ...
          , X = f(function(t) {
            ...
            t.init = function(t, e, n, r) {
                ...
                this.string = this.name + w + this.duration + "ms" + ("ease" != this.ease ? w + l[this.ease][0] : "") + (this.delay ? w + this.delay + "ms" : ""))
            }
            ,
            t.set = function(t) {
        ...
        x.transform && x.backface && (q.z = [I, "translateZ"],
        q.rotateZ = [T],
        q.scaleZ = [g],
        q.perspective = [m]);
        var $ = /ms/
    ...
    t.exports = function(t, e, n, c, s, f) {
        ...
        f.set(e, t); ++h < d; ) {
            var g = t[h]
              , y = e[h];
            if (c)
                var m = l ? c(y, g, h, e, t, f) : c(g, y, h, t, e, f);
            if (void 0 !== m) {
                if (m)
                    continue;
                E = !1;
...
, function(t, e, n) {
    ...
    function _t(t) {
        ...
        if (!B(E, p.mediaQueryKey))
            return !1;
        var O = p.hasBoundaryNodes && r ? I.getClosestElement(r, A) : null
          , b = j(T)
          , w = !1;
...
, function(t, e, n) {
    var r, i = n(141), o = (r = /[^.]+$/.exec(i && i.keys && i.keys.IE_PROTO || "")) ? "Symbol(src)_1." + r : "";
    t.exports = function(t) {
        return !!o && o in t
    }
}
...
, function(t, e, n) {
    ...
    function yt(t) {
        ...
        var w, S, R, N = (0,
        p.default)(n, "action.config.affectedElements", {})[g || I] || {}, C = Boolean(N.id || N.selector), x = n && u(gt(n.target));
        if (C ? (w = N.limitAffectedElements,
        S = x,
        R = u(N)) : S = R = u({
            id: g,
            selector: I,
        ...
        return null == S || null == R ? [] : y.IS_BROWSER_ENV && i ? c(R).filter(function(t) {
            return i.contains(t)
        }) : w === X ? c(S, R) : w === G ? s(c(S)).filter(l(R)) : w === k ? f(c(S)).filter(l(R)) : c(R)
    }
    var mt = /px/
      , It = function(t, e) {
    ...
    var r = n(2)
      ...
      , T = function(t, e) {
        ...
        if (E && !_)
            ...
            for (var F = (O - g) / m, j = E.config.easing, X = h(j, F, f), G = 0, k = a.length; G < k; G++) {
                var V = a[G]
                  , U = y(s, V, E.config)
      ...
      , O = function(t, e) {
        ...
        if (r && i) {
            ...
            if (s) {
                ...
                t = (0,
                o.set)(t, "verboseTimeElapsed", w * S)
            }
            if (b < 0)
                return t;
...
, function(t, e, n) {
    ...
    o.default)(r, P, {
        ...
        handler: function(t) {
            ...
            (u !== h.EventBasedOn.ELEMENT || S || S !== a.elementHovered) && (A = f ? 1 - A : A,
            e.dispatch((0,
            _.parameterChanged)(w, A))),
            {
                elementHovered: S,
                clientX: v,
                clientY: g,
...
, function(t, e, n) {
    ...
    r.define("navbar", t.exports = function(t, e) {
        var n, o, a, u, c = {}, s = t.tram, f = t(window), l = t(document), d = r.env(), p = '<div class="w-nav-overlay" data-wf-ignore />', v = ".w-nav", h = "w--open", E = "w--nav-dropdown-open", _ = "w--nav-dropdown-toggle-open", g = "w--nav-dropdown-list-open", y = "w--nav-link-open", m = i.triggers, I = t();
        function T() {
            r.resize.off(O)
        }
        function O() {
        ...
        function b(n, i) {
            ...
            c.button.on("click" + v, function(t) {
...
, function(t, e, n) {
    ...
    r.define("tabs", t.exports = function(t) {
        var e, n, o = {}, a = t.tram, u = t(document), c = r.env, s = c.safari, f = c(), l = "data-w-tab", d = "data-w-pane", p = ".w-tabs", v = "w--current", h = "w--tab-active", E = i.triggers, _ = !1;
        function g() {
            n = f && r.env("design"),
            (e = u.find(p)).length && (e.each(I),
            r.env("preview") && !_ && e.each(m),
            y(),
        ...
        function m(e, n) {
            var r = t.data(n, p);
            r && (r.links && r.links.each(E.reset),
        ...
        function T(e, n) {
            ...
            if (u !== e.current) {
                ...
                var p = t(f)
                  , g = t(d);
                if (n.immediate || i.immediate)
                    return p.addClass(h).each(E.intro),
                    g.removeClass(h),
                    void (_ || r.redraw.up());
                ...
                c.focus(),
                window.scrollTo(y, m),
                g.length && i.outro ? (g.each(E.outro),
    ...
    "events": {
        ...
        "e-2": {
            ...
            "target": {
                ...
                "originalId": "5eb98b2079b4fc0adc5a89f4|06dd5fec-2b9f-8dc4-de7b-978e5277f3b3",
                "appliesTo": "CLASS"
            },
            "config": {
                "loop": false,
        ...
        "e-6": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5eb98b2079b4fc0adc5a89f4|9b6cb8cd-9551-102b-01b7-4b260b7d3226"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-8": {
            ...
            "target": {
                ...
                "originalId": "5eb98b2079b4fc0adc5a89f4|0e2bf88e-17e0-8ee7-fccf-82be762babea",
                "appliesTo": "CLASS"
            },
            "config": {
                "loop": false,
        ...
        "e-10": {
            ...
            "target": {
                "selector": ".project-wrapper",
                "originalId": "5eb98b2079b4fc0adc5a89f4|f8f793d3-58bd-f512-c602-9d09cbd39316",
                "appliesTo": "CLASS"
            },
            "config": {
                "loop": false,
        ...
        "e-14": {
            ...
            "target": {
                ...
                "originalId": "5eb98b2079b4fc0adc5a89f4|559d68de-bb9d-d8ba-a590-9f2d45f6fa7c",
                "appliesTo": "CLASS"
            },
            "config": {
                "loop": false,
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "5eb98b2079b4fc0adc5a89f4|77334a47-0ad3-0eee-7d4a-87b22127ebb1"
                            },
                            "xValue": 0,
                            "xUnit": "%",
                            "yUnit": "PX",
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": true,
                            "id": "5eb98b2079b4fc0adc5a89f4|06dd5fec-2b9f-8dc4-de7b-978e5277f3b3"
                        },
                        "xValue": 1.02,
                        "yValue": 1.02,
                        "locked": true
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["36dc0f79-8291-dc26-f3fd-175c27d0114c"]
                        },
                        "rValue": 0,
                        "gValue": 255,
                        "bValue": 255,
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "ee744c24-2d72-fc7a-55c0-5579bd20ef0b"
                        },
                        "value": 0,
                        "unit": ""
                    }
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "5eb98b2079b4fc0adc5a89f4|3cb0f931-ad23-8f11-e7c9-7467d5aa3ec3"
                        },
                        "xValue": -100,
                        "xUnit": "%",
                        "yUnit": "PX",
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "5eb98b2079b4fc0adc5a89f4|b434fee8-91a2-d622-5bd9-d641a4ebd0a9"
                        },
                        "xValue": 110,
                        "xUnit": "%",
                        "yUnit": "PX",
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "5eb98b2079b4fc0adc5a89f4|cced083d-161a-17da-b995-b9a844024b18"
                        },
                        "xValue": 110,
                        "xUnit": "%",
                        "yUnit": "PX",
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "id": "5eb98b2079b4fc0adc5a89f4|4e28eed4-39c1-89df-92b9-551fe582d8b2"
                        },
                        "xValue": -100,
                        "xUnit": "PX",
                        "yUnit": "PX",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "id": "5eb98b2079b4fc0adc5a89f4|64e7d109-0529-b91a-b15e-08accd24e160"
                        },
                        "xValue": -100,
                        "xUnit": "PX",
                        "yUnit": "PX",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "id": "5eb98b2079b4fc0adc5a89f4|b7e1d0fe-20c6-3f36-2882-55d26141319b"
                        },
                        "xValue": -100,
                        "xUnit": "PX",
                        "yUnit": "PX",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".skill-icon",
                            "selectorGuids": ["b483438c-5e35-1015-8fec-8a2afc8f02ed"]
                        },
                        "xValue": 1.2,
                        "yValue": 1.2,
                        "locked": true
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": true,
                            "id": "5eb98b2079b4fc0adc5a89f4|f8f793d3-58bd-f512-c602-9d09cbd39316"
                        },
                        "xValue": 0.85,
                        "yValue": 0.85,
                        "locked": true
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "5eb98b2079b4fc0adc5a89f4|94f9858b-c4ab-aa43-1f77-88e8597f6136"
                            },
                            "xValue": 0,
                            "locked": false
                        }
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".arrow-div",
                            "selectorGuids": ["b442615d-f4eb-a05a-61b0-d67b92ab67aa"]
                        },
                        "xValue": 48,
                        "yValue": 48,
                        "xUnit": "PX",
